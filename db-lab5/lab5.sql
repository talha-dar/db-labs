...
-- Task 4
select salary, dno, sex from employee where sex = 'F';
...
-- task 8
insert into project values("Image Processing",4,"USA",6);
select * from project;

-- task 9
update project set plocation="London" where pname="OperatingSystems";
select * from project;

-- task 10
delete from project where pname="Image Processing";
select * from project;
